        ...
        <div className='header'>
            ...
            >
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", marginTop: "-2rem" }}>
                    <div className="avatar" style={{ width: "5rem", height: "5rem" }}></div>
                    <h4 style={{ margin: "0.5rem 0" }}>@bhojakS</h4>
                    <h3>Smith Bhojak</h3>
                    <h4 className='silent-text' style={{ margin: "0.5rem 0" }}>+91-9876543210</h4>
                ...
                <NavLink to="/" style={{ textDecoration: "none" }}>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }} onClick={() => { setOpened(false) }}>
                        <img src={signout} alt="signout" style={{ marginRight: "0.5rem" }} loading="lazy" />
                        <p style={{ textAlign: "center", color: "red", cursor: "pointer" }}>Sign out</p>
                    </div>
                </NavLink>
                <Divider my="md" size="xs" />
            </Modal>
